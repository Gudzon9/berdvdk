        ...
        <div class="row-fluid">
            <!--Edit Main Content Area here-->
                <div class="span12" id="divMain">
					...
					<p>3.1. Усі права на використання змісту сайту, крім випадків, зазначених у змісті опублікованих на сайті матеріалів, належать <span class="maincolor"><?php echo $T_OWNERNAME ?></span>.<br>
					   3.2. Користувач може завантажувати («скачувати») з сайту матеріали тільки для особистого використання.<br>
					   3.3. Дозволено використання інформації засобами масової інформації за умови дотримання умов цієї Угоди а також умов, які передбачені на сторінках, де розміщений контент. При цьому посилання на <span class="maincolor"><?php echo $T_OWNERNAME ?></span>, а для інтернет ЗМІ – гіперпосилання на <span class="maincolor">www.<?php echo $A_SITE ?></span> обов'язкове.</p>					
                </div>
