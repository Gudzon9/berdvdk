...
<div class="container">
    ...
    <div class="divPanel page-content">
		...
		<? echo "<h3>Споживачі, що заборгували за отримані послуги більше ніж 800.00 гривень станом на ".$monthsnext[$mesnext]." ".$godnext." року : </h3>" ?>
			...
			<table class="table table-condensed table-hover" style="background-color:#FFFACD"> 	
				...
				If ($records==0) {
					...
					$result = mysql_query("INSERT into `borg` (ks, per, rahshort, adr, borg)
						...
						FROM (SELECT rah, per, sborgbeg+snar-sopl-spilg-ssubs-skor as borg FROM month WHERE ks='$OWNERKS' and per='$closPer' having borg>800) as X 
