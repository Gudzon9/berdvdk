        ...
        <div class="divPanel">
            ...
            <div class="row-fluid">
                ...
                <div class="span3" id="footerArea3">
                    ...
                    <p> 
						<a href="#" title=""><i class="general foundicon-phone icon"></i> Диспетчер <?php echo $K_TELDISP ?></a><br />
                        <a href="usersogl.php" title="">Угода з користувачем</a><br />                        
						<a href="#" title="">Угода зi споживачем</a><br />                        						
